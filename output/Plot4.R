############################################################
##   Exploratory Data Analys Module - Project 1 - Plot 4  ##
...
# Global Active Power - R1,C1
plot(hpc1$Date2, hpc1$Global_active_power, type="l", 
     xlab="", ylab="Global Active Power (kilowatts)")

# Voltage - R1,C2
plot(hpc1$Date2, hpc1$Voltage, type="l", 
...
# Global Reactive Power - R2,C2
plot(hpc1$Date2, hpc1$Global_reactive_power, type="l", 
